const { validateAgentSelection } = require('./agent_profiles')
...
function loadActionDefinitions(files, dependencies = {}) {
...
module.exports = { BUILTIN_CUSTOM_PROMPT, CUSTOM_PROMPT_ACTION_NAME, loadActionDefinitions }
