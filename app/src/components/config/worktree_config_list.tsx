...
const WORKTREE_SUBSECTION_DESCRIPTION = 'Add chooses an empty folder. Changes are applied to Git only after Save.'
const WORKTREE_SUBSECTION_ID = 'project-worktrees'
...
export function WorktreeConfigList() {
    ...
    return (
        <ConfigSubsection
            description={WORKTREE_SUBSECTION_DESCRIPTION}
            id={WORKTREE_SUBSECTION_ID}
