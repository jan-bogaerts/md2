...
import { GithubUnauthorizedError } from './githubApiClient'
import { AUTH_TOKEN_STORAGE_KEY, type AuthStorage, type GithubDeviceCode, type GithubUser } from './githubAuthTypes'
...
function createService(overrides: Partial<ConstructorParameters<typeof GithubAuthService>[0]> = {}) {
    ...
    return { dependencies, service: new GithubAuthService(dependencies), storage }
}
