...
policy:
  checkLinting: true
  requireTests: true
internalId: ba078153-40e3-4308-ba39-47cc1ce3976e
---
...
- For non-streaming actions, the conversation UI shows live output, disables input during a turn, and starts a new process for follow-up input after completion.
...
- For non-streaming actions, conversation input is disabled while a turn runs. Text submitted after completion starts a one-shot follow-up in the same conversation.
