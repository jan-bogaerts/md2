...
3. Wait for approval.
4. include tests
5. After implementation is done, update the field `status` in the markdown feature description file to `ready`
...
Respect the Test Plan and Acceptance Criteria. Be short and to the point, use $caveman skill.
