...
**Message:** External change ignored for design/feature_descriptions/B_154_conversation_selector_disabled_while_conversation_is_running.md because the file has unsaved local edits.
