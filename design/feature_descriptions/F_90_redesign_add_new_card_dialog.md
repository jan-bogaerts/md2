...
- Use only existing tokens from `STYLE_GUIDE.md` — surface, page, track, hover, border, border-strong, text-1…4, primary, primary-strong, primary-bg, on-primary. No new colors.
