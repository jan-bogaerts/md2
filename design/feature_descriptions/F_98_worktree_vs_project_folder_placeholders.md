...
We have 'project-folder' placeholder. this currently maps to the folder that the agent is running on, so it could the the main project folder or a worktree.&#x20;
